...
module.exports = grammar.export_grammar({
    ...
    VAL__NOTEQEQ: { OPERATOR: '==', VALUE: '!==' },
    VAL__NEW_LINE: { OPERATOR: '==', VALUE: '\n' },
    ...
    VAL__PERC: { OPERATOR: '==', VALUE: '%' },
    VAL__PIPE: { OPERATOR: '==', VALUE: '[|]' },
    VAL__PLUS: { OPERATOR: '==', VALUE: '[+]' },
    VAL__QUESTION_MARK: { OPERATOR: '==', VALUE: '[?]' },
