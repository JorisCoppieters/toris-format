...
module.exports = grammar.export_grammar({
  ...
  CLASS_IMPLEMENTS: { OPERATOR: '&&', SEGMENTS: ['TOKEN__IMPLEMENTS', 'VAL__CLASS_NAME'] },
  ...
  CLASS_BOUND_DECLARATION: { OPERATOR: '&&', SEGMENTS: ['CLASS_BINDING', 'ACCESS_MODIFIER?', 'CLASS_BINDING_VALUE'] },
  ...
  CLASS_BINDING_TOKEN: { OPERATOR: '||', SEGMENTS: ['TOKEN__INPUT', 'TOKEN__HOST_BINDING'] },
  ...
  CLASS_ACCESSOR_DECLARATION: { OPERATOR: '&&', SEGMENTS: ['ACCESSOR', 'VAL__LETTERS', 'FUNCTION', 'BLOCK'] },
  CLASS_NAMED_DECLARATION: { OPERATOR: '&&', SEGMENTS: ['VAL__LETTERS', 'CLASS_NAMED_DECLARATION_TYPE'] },
  CLASS_NAMED_DECLARATION_TYPE: { OPERATOR: '||', SEGMENTS: ['CLASS_NAMED_FUNCTION_DECLARATION', 'CLASS_NAMED_FIELD_DECLARATION'] },
  ...
  CLASS_DOT_NAMESPACES: { OPERATOR: '&&', SEGMENTS: ['CLASS_DOT_NAMESPACE+'] },
  CLASS_DOT_NAMESPACE: { OPERATOR: '&&', SEGMENTS: ['VAL__LETTERS', 'VAL__DOT'] },
  CLASS_VARIABLE_NAME: { OPERATOR: '&&', SEGMENTS: ['CLASS_DOT_NAMESPACES?', 'VAL__VARIABLE_NAME'] },

  CLASS_VALUE: { OPERATOR: '&&', SEGMENTS: ['CLASS_DOT_NAMESPACES?', 'CLASS_VALUE_TYPES'] },
  CLASS_VALUE_TYPES: { OPERATOR: '||', SEGMENTS: ['CLASS_FUNCTION_CALL', 'VAL__VARIABLE_NAME'] },

  CLASS_BLOCK_VALUE: { OPERATOR: '&&', SEGMENTS: ['CLASS_DOT_NAMESPACES?', 'CLASS_BLOCK_VALUE_CALL', 'VAL__SEMI'] },
  ...
  BLOCK_CONTENT: { OPERATOR: '||', SEGMENTS: ['CLASS_BLOCK_VALUE', 'CONDITIONAL_STATEMENT'] },
  SQUARE_BRACKETS_VALUE: { OPERATOR: '&&', SEGMENTS: ['VAL__SQBRAC_L', 'STRING_VALUE', 'VAL__SQBRAC_R'] },
  VARIABLE_VALUE: { OPERATOR: '||', SEGMENTS: ['VAL__NUMERIC', 'BOOLEAN_VALUE', 'STRING_VALUE'] },
