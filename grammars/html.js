...
var DEFINITION = {
  ...
  HTML_ELEMENT_ATTRIBUTE_VALUE_EMPTY: { OPERATOR: '==', VALUE: r_dq('') },
  ...
  HTML_STYLE_OPEN_ELEMENT: { OPERATOR: '==', REGEXP: new RegExp('^' + r_v(r_W) + '<style[^>]*>' + r_v(r_AG) + '$', 'i') },
  HTML_STYLE_CLOSE_ELEMENT: { OPERATOR: '==', REGEXP: new RegExp('^' + r_v(r_W) + '<\/style>' + r_v(r_AG) + '$', 'i') },
  HTML_CONTENT: { OPERATOR: '==', REGEXP: new RegExp('^' + r_v(r_W) + r_v('[^<]+?') + r_v(r_W + '<' + r_AG) + '$', 'i') },
  HTML_COMMENT: { OPERATOR: '==', REGEXP: new RegExp('^' + r_v(r_W) + '<!--' + r_W + r_v(r_A) + r_W + '-->' + r_v(r_AG), 'i') },
};
